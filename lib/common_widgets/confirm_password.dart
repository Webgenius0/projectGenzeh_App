...
class ConfirmPasswordWidget extends StatefulWidget {
  ...
  ConfirmPasswordWidget({
    ...
    this.textColor = AppColors.c00B822,
  }) : super(key: key);
...
class _PasswordTextFieldState extends State<ConfirmPasswordWidget> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        hintStyle: TextFontStyle.textStyle14c252C2EUrbanistW400.copyWith(
