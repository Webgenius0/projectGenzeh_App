...
class OnboardingPageEight extends StatefulWidget {
  final String title;
  final String? descriptionOne;
  final String? descriptionTwo;

  const OnboardingPageEight(
      {super.key,
      required this.title,
      this.descriptionOne,
      this.descriptionTwo});
  ...
  @override
  State<OnboardingPageEight> createState() => _OnboardingPageEightState();
}

class _OnboardingPageEightState extends State<OnboardingPageEight> {
  int selectedIndex = -1;
  @override
